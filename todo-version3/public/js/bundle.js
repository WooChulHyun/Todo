...
function () {
  ...
  _createClass(Todo, [{
    ...
    value: function generateId() {
      return this.$todos.childNodes.length ? +this.$todos.childNodes[0].id + 1 : 1;
    }
  }, {
    key: "getTodos",
    value: function getTodos() {
      ...
      fetch('/todos').then(function (res) {
        ...
        _this.render(todoList);
      })["catch"](console.error);
    }
  }, {
    key: "render",
    value: function render(todoList) {
      ...
      if (this.navState === 'all') {
        ...
        newTodos = todoList.filter(function (item) {
      ...
      newTodos.forEach(function (item) {
        html += "<li id=\"".concat(item.id, "\" class=\"todo-item\">\n       <input class=\"custom-checkbox\" type=\"checkbox\" id=\"ck-").concat(item.id, "\" ").concat(item.completed ? 'checked' : '', ">\n       <label for=\"ck-").concat(item.id, "\">").concat(item.content, "</label>\n       <i class=\"remove-todo far fa-times-circle\"></i>\n     </li>\n");
    ...
    key: "changeComplete",
    value: function changeComplete(itemId, e) {
      var _this2 = this;
      ...
      fetch("/todos/".concat(itemId), {
        ...
        _this2.render(todoList);
      })["catch"](console.error);
    }
  }, {
    key: "completedTodo",
    value: function completedTodo(e) {
      this.changeComplete(+e.target.parentNode.id, e);
    }
  }, {
    key: "removeTodoList",
    value: function removeTodoList(itemId) {
      var _this3 = this;
    ...
    value: function createNewTodoList() {
      var _this4 = this;
      ...
      fetch('/todos', {
        ...
        _this4.render(todoList);
      })["catch"](console.error);
    }
  }, {
    key: "createNewTodo",
    value: function createNewTodo(e) {
      if (this.$inputTodo.value.trim() === '' || e.keyCode !== 13) return;
      this.createNewTodoList();
    }
  }, {
    key: "checkAllList",
    value: function checkAllList(e) {
      var _this5 = this;
    ...
    key: "navChange",
    value: function navChange(e) {
      if (e.target.nodeName !== 'LI') return;

      _toConsumableArray(this.$nav.children).forEach(function (item) {
